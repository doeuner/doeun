  ...
  return (
    <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
        <div className="flex items-center">
            <div onClick={()=>setSideNav(!sideNav)} className="cursorr-pointer">
                <AiOutlineMenu size={25} />
            </div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
                DoeuNeR <span className="font-bold">요리교실</span>
            </h1>
    ...
    <div className={sideNav?"fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300":
       ...
       <AiOutlineClose onClick={()=>setSideNav(!sideNav)} size={25}
        ...
        <h2 className="text-2xl p-4">Wein's<span clasName="text-orange-700 font-bold">요리교실</span></h2> 
        <nav>
